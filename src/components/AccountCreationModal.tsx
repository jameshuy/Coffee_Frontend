...
import { LockKeyhole, Loader2, Check, X, UserCheck } from "lucide-react";
      ...
      <DialogContent className="sm:max-w-[425px] bg-black border-[#f1b917] text-white">
        <DialogHeader>
          ...
          <DialogDescription className="text-center text-white">
            {step === "verification"
              ? `We've sent a 6-digit verification code to ${email}. Please check your inbox and enter the code below:`
              : ""}
          </DialogDescription>
        </DialogHeader>
